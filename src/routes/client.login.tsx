...
function ClientLogin() {
  ...
  function submit(e: React.FormEvent) {
    e.preventDefault();
    const biz = store.getByLogin(u, p);
    ...
    <div className="min-h-screen grid place-items-center bg-slate-50 px-4">
      <div className="w-full max-w-md bg-white rounded-2xl border shadow-sm p-8">
        <div className="flex items-center gap-3 mb-6">
          <div className="h-11 w-11 rounded-lg bg-blue-600 text-white grid place-items-center"><Users className="h-5 w-5" /></div>
          <div>
        ...
        <form onSubmit={submit} className="space-y-3">
          ...
          <button className="w-full bg-blue-600 text-white py-2.5 rounded-md font-semibold hover:bg-blue-700">Login</button>
        </form>
